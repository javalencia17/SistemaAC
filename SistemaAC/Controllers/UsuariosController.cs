...
namespace SistemaAC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //recorro todos los valores del usuario
        ...
        // este metodo permite obtener los datos de un usuario especifico
        ...
        public async Task<string> EditUsuario(String id, String userName,String email,
            ...
            String normalizedUserName,String normalizedEmail,String passwordHash,bool phoneNumberConfirmed,
        ...
        public async Task<String> DeleteUsuario(String id)
        {
            ...
            try
            {
                var aplicationUser = await _context.ApplicationUser.SingleOrDefaultAsync(m => m.Id == id);
                _context.ApplicationUser.Remove(aplicationUser);
                await _context.SaveChangesAsync();
                resp = "Delete";
            }
            catch (Exception)
